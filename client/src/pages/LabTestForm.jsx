...
return ( <div className="fixed inset-0 bg-black bg-opacity-40 flex justify-center items-center z-50 overflow-auto"> <div className="bg-white dark:bg-gray-900 rounded-lg p-6 w-full max-w-3xl shadow-xl relative max-h-[90vh] overflow-y-auto text-gray-900 dark:text-gray-100"> <button
       onClick={onClose}
       className="absolute top-3 right-3 text-gray-400 hover:text-red-500"
     > <X size={20} /> </button> <h2 className="text-2xl font-semibold mb-4 text-center text-blue-600">
Create Lab Test </h2>
    {successMessage && (
        ...
        >
          ...
          {testType === "GeneXpert" ? (
            ...
            <div className="flex flex-col gap-2">
              <label className="font-medium mb-1">Radiological Impression:</label>
              <div className="flex flex-col gap-2">
                {[
                  "Normal",
                  "Suggestive of TB",
